...
public class NotificationConsumer {
    ...
    public NotificationConsumer(KinesisClient kinesisClient, SimpMessagingTemplate messagingTemplate, AdmissionService admissionService) {
                    ...
                    for (software.amazon.awssdk.services.kinesis.model.Record record : response.records()) {
                        ...
                        try {
                            ...
                            if ("ADMIT".equals(action) && sessionId != null) {
                                ...
                                Map<String, String> payload = Map.of("status", "ADMITTED", "message", "입장이 허가되었습니다. 예매를 진행해주세요.");
